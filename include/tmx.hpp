...
public:
    ...
    void add_callback(MESSAGE_IN_TYPE type, std::function<void(std::vector<uint8_t>)> callback);
...
public:
    ...
    void setPinMode(uint8_t pin, TMX::PIN_MODES mode, bool reporting = true, uint16_t analog_differential = 1);
